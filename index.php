				...
				<div class="mt-5 border rounded">   
					<div class="col-12 px-1">
						<div class="row">
							<div class="col-8">
								<div class="row">
									<div class="col-3 text-right pb-4 pt-2">
										<img src="3.png" class="w-75 rounded-circle">
									</div>
							...
							<div class="col-4">		
								<form action="delete.php" method="GET">
				 					...
				 					<button class="btn deletee mt-2" style=""><i class="fa fa-trash"></i></button>							
			 					</form>		
							</div>														
						</div>
					</div>
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<button class="btn btn1" style=""><i class="fa fa-pencil-square-o"> </i></button>
						<form action="update.php" method="GET" style="display: none" class="update">
							<input type="" name="id" value="<?php echo $stroka["id"] ?>" class="form-control mt-2">
							<input type="" name="text" value="<?php echo $stroka["text"] ?>" class="form-control mt-2">
							<input type="" name="img" value="<?php echo $stroka["img"] ?>" class="form-control mt-2">
